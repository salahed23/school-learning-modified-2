...
return [
    ...
    | versions, comme les règles de taille. N'hésitez pas à modifier chacun
    | de ces messages ici.
    |
    */
    ...
    'gte' => [
        ...
        'file' => 'Le fichier :attribute doit peser :value kilo-octets ou plus.',
    ...
    'lte' => [
        ...
        'file' => 'Le fichier :attribute doit peser :value kilo-octets ou moins.',
    ...
    | des attributs en utilisant la convention "attribut.règle" pour nommer
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer nos places de
    | marché d'attributs par quelque chose de plus convivial pour le lecteur,
